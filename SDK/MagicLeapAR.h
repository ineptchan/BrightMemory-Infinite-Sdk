...
public:
	...
	// void StartLuminARSession(class UObject* WorldContextObject, FLatentActionInfo LatentInfo, class ULuminARSessionConfig* Configuration); // [0xf316f0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// bool LuminARLineTrace(class UObject* WorldContextObject, FVector2D& ScreenPosition, TSet<ELuminARLineTraceChannel> TraceChannels, TArray<FARTraceResult>& OutHitResults); // [0xf31430] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeapAR.LuminARFrameFunctionLibrary.GetTrackingState
	// ELuminARTrackingState GetTrackingState();                                                                                // [0xf313e0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// TArray<float> GetAmbientIntensityNits();                                                                                 // [0xf312e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool GetUseUnreliablePose();                                                                                             // [0xf31410] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MagicLeapAR.LuminARCandidateImage.GetImageIsStationary
	// bool GetImageIsStationary();                                                                                             // [0xf313c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MagicLeapAR.LuminARCandidateImage.GetAxisOrientation
	// EMagicLeapImageTargetOrientation GetAxisOrientation();                                                                   // [0xf313a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
