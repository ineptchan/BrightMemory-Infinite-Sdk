...
public:
	...
	// void SetSequencePath(FString Path);                                                                                      // [0xf678c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ImgMedia.ImgMediaSource.GetSequencePath
	// FString GetSequencePath();                                                                                               // [0xf67800] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ImgMedia.ImgMediaSource.GetProxies
	// void GetProxies(TArray<FString>& OutProxies);                                                                            // [0xf67730] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
