...
{ 
public:
	SDK_UNDEFINED(80,862) /* TSet<AChaosSolverActor*> */ __um(ChaosSolverActorSet);                                // 0x0038   (0x0050)  
	...
	SDK_UNDEFINED(80,863) /* TSet<UPhysicalMaterial*> */ __um(ChaosBreakingMaterialSet);                           // 0x0138   (0x0050)  
...
public:
	...
	unsigned char                                      UnknownData00_7[0x24];                                      // 0x006C   (0x0024)  MISSED
};
