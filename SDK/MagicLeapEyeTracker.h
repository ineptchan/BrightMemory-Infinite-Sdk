...
public:
	...
	// bool GetEyeBlinkState(FMagicLeapEyeBlinkState& BlinkState);                                                              // [0xf3b5d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapEyeTracker.MagicLeapEyeTrackerFunctionLibrary.GetCalibrationStatus
	// EMagicLeapEyeTrackingCalibrationStatus GetCalibrationStatus();                                                           // [0xf3b5a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
