...
public:
	...
	// bool RequestPrivilegeAsync(EMagicLeapPrivilege Privilege, FDelegateProperty& ResultDelegate);                            // [0xf4f6f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.RequestPrivilege
	// bool RequestPrivilege(EMagicLeapPrivilege Privilege);                                                                    // [0xf4f670] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.CheckPrivilege
	// bool CheckPrivilege(EMagicLeapPrivilege Privilege);                                                                      // [0xf4f670] Final|Native|Static|Public|BlueprintCallable 
};
