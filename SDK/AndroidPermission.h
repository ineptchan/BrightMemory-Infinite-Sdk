...
{ 
public:
	SDK_UNDEFINED(16,274) /* FMulticastInlineDelegate */ __um(OnPermissionsGrantedDynamicDelegate);                // 0x0028   (0x0010)  
...
public:
	...
	// bool CheckPermission(FString permission);                                                                                // [0x1075500] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AndroidPermission.AndroidPermissionFunctionLibrary.AcquirePermissions
	// class UAndroidPermissionCallbackProxy* AcquirePermissions(TArray<FString>& Permissions);                                 // [0x1075430] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
