...
public:
	...
	// bool SetMotionSourceForHand(EControllerHand Hand, FName MotionSource);                                                   // [0xf3a3b0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.SetControllerTrackingMode
	// bool SetControllerTrackingMode(EMagicLeapControllerTrackingMode TrackingMode);                                           // [0xf39a30] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.PlayLEDPattern
	// bool PlayLEDPattern(FName MotionSource, EMagicLeapControllerLEDPattern LEDPattern, EMagicLeapControllerLEDColor LEDColor, float DurationInSec); // [0xf3a260] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.PlayLEDEffect
	// bool PlayLEDEffect(FName MotionSource, EMagicLeapControllerLEDEffect LEDEffect, EMagicLeapControllerLEDSpeed LEDSpeed, EMagicLeapControllerLEDPattern LEDPattern, EMagicLeapControllerLEDColor LEDColor, float DurationInSec); // [0xf3a090] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.PlayHapticPattern
	// bool PlayHapticPattern(FName MotionSource, EMagicLeapControllerHapticPattern HapticPattern, EMagicLeapControllerHapticIntensity Intensity); // [0xf39f90] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.PlayControllerLEDEffect
	// bool PlayControllerLEDEffect(EControllerHand Hand, EMagicLeapControllerLEDEffect LEDEffect, EMagicLeapControllerLEDSpeed LEDSpeed, EMagicLeapControllerLEDPattern LEDPattern, EMagicLeapControllerLEDColor LEDColor, float DurationInSec); // [0xf39dc0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.PlayControllerLED
	// bool PlayControllerLED(EControllerHand Hand, EMagicLeapControllerLEDPattern LEDPattern, EMagicLeapControllerLEDColor LEDColor, float DurationInSec); // [0xf39c70] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.PlayControllerHapticFeedback
	// bool PlayControllerHapticFeedback(EControllerHand Hand, EMagicLeapControllerHapticPattern HapticPattern, EMagicLeapControllerHapticIntensity Intensity); // [0xf39b60] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.MaxSupportedMagicLeapControllers
	// int32_t MaxSupportedMagicLeapControllers();                                                                              // [0xf2bd40] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.IsMLControllerConnected
	// bool IsMLControllerConnected(FName MotionSource);                                                                        // [0xf39910] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.InvertControllerMapping
	// void InvertControllerMapping();                                                                                          // [0xf39b40] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.GetMotionSourceForHand
	// FName GetMotionSourceForHand(EControllerHand Hand);                                                                      // [0xf39ab0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.GetMLControllerType
	// EMagicLeapControllerType GetMLControllerType(EControllerHand Hand);                                                      // [0xf39a30] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.GetHandForMotionSource
	// EControllerHand GetHandForMotionSource(FName MotionSource);                                                              // [0xf399a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.GetControllerType
	// EMagicLeapControllerType GetControllerType(FName MotionSource);                                                          // [0xf39910] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.GetControllerTrackingMode
	// EMagicLeapControllerTrackingMode GetControllerTrackingMode();                                                            // [0xf398e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapController.MagicLeapControllerFunctionLibrary.GetControllerMapping
	// bool GetControllerMapping(int32_t ControllerIndex, EControllerHand& Hand);                                               // [0xf39810] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(16,958) /* FMulticastInlineDelegate */ __um(OnTouchpadGestureStart);                             // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,959) /* FMulticastInlineDelegate */ __um(OnTouchpadGestureContinue);                          // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,960) /* FMulticastInlineDelegate */ __um(OnTouchpadGestureEnd);                               // 0x00D8   (0x0010)  
