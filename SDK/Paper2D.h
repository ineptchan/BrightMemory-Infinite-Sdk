...
public:
	...
	// bool IsValidKeyFrameIndex(int32_t Index);                                                                                // [0xde3690] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetTotalDuration
	// float GetTotalDuration();                                                                                                // [0xde35d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetSpriteAtTime
	// class UPaperSprite* GetSpriteAtTime(float Time, bool bClampToEnds);                                                      // [0xde2d40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetSpriteAtFrame
	// class UPaperSprite* GetSpriteAtFrame(int32_t FrameIndex);                                                                // [0xde2ca0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetNumKeyFrames
	// int32_t GetNumKeyFrames();                                                                                               // [0xde2bf0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetNumFrames
	// int32_t GetNumFrames();                                                                                                  // [0xde2bc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetKeyFrameIndexAtTime
	// int32_t GetKeyFrameIndexAtTime(float Time, bool bClampToEnds);                                                           // [0xde2910] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x04C0 (1216 bytes) (0x000470 - 0x0004C0) align 16 MaxSize: 0x04C0
class UPaperFlipbookComponent : public UMeshComponent
{ 
public:
	class UPaperFlipbook*                              SourceFlipbook;                                             // 0x0470   (0x0008)  
	class UMaterialInterface*                          Material;                                                   // 0x0478   (0x0008)  
	float                                              PlayRate;                                                   // 0x0480   (0x0004)  
	bool                                               bLooping : 1;                                               // 0x0484:0 (0x0001)  
	bool                                               bReversePlayback : 1;                                       // 0x0484:1 (0x0001)  
	bool                                               bPlaying : 1;                                               // 0x0484:2 (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0485   (0x0003)  MISSED
	float                                              AccumulatedTime;                                            // 0x0488   (0x0004)  
	int32_t                                            CachedFrameIndex;                                           // 0x048C   (0x0004)  
	FLinearColor                                       SpriteColor;                                                // 0x0490   (0x0010)  
	class UBodySetup*                                  CachedBodySetup;                                            // 0x04A0   (0x0008)  
	SDK_UNDEFINED(16,988) /* FMulticastInlineDelegate */ __um(OnFinishedPlaying);                                  // 0x04A8   (0x0010)  
	unsigned char                                      UnknownData01_7[0x8];                                       // 0x04B8   (0x0008)  MISSED


	/// Functions
	// Function /Script/Paper2D.PaperFlipbookComponent.Stop
	// void Stop();                                                                                                             // [0xde49b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetSpriteColor
	// void SetSpriteColor(FLinearColor NewColor);                                                                              // [0xde4560] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlayRate
	// void SetPlayRate(float NewRate);                                                                                         // [0xde4330] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlaybackPositionInFrames
	// void SetPlaybackPositionInFrames(int32_t NewFramePosition, bool bFireEvents);                                            // [0xde4490] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlaybackPosition
	// void SetPlaybackPosition(float NewPosition, bool bFireEvents);                                                           // [0xde43b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetNewTime
	// void SetNewTime(float NewTime);                                                                                          // [0xde42b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetLooping
	// void SetLooping(bool bNewLooping);                                                                                       // [0xde4220] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetFlipbook
	// bool SetFlipbook(class UPaperFlipbook* NewFlipbook);                                                                     // [0xde3e70] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.ReverseFromEnd
	// void ReverseFromEnd();                                                                                                   // [0xde3d70] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.Reverse
	// void Reverse();                                                                                                          // [0xde3d50] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.PlayFromStart
	// void PlayFromStart();                                                                                                    // [0xde3ba0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.Play
	// void Play();                                                                                                             // [0xde3b80] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.OnRep_SourceFlipbook
	// void OnRep_SourceFlipbook(class UPaperFlipbook* OldFlipbook);                                                            // [0xde3ac0] Final|Native|Protected 
	// Function /Script/Paper2D.PaperFlipbookComponent.IsReversing
	// bool IsReversing();                                                                                                      // [0xde3660] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.IsPlaying
	// bool IsPlaying();                                                                                                        // [0xde3630] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.IsLooping
	// bool IsLooping();                                                                                                        // [0xde3600] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetSpriteColor
	// FLinearColor GetSpriteColor();                                                                                           // [0xde2e10] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetPlayRate
	// float GetPlayRate();                                                                                                     // [0xde2c10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetPlaybackPositionInFrames
	// int32_t GetPlaybackPositionInFrames();                                                                                   // [0xde2c70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetPlaybackPosition
	// float GetPlaybackPosition();                                                                                             // [0xde2c40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbookLengthInFrames
	// int32_t GetFlipbookLengthInFrames();                                                                                     // [0xde2750] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbookLength
	// float GetFlipbookLength();                                                                                               // [0xde2720] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbookFramerate
	// float GetFlipbookFramerate();                                                                                            // [0xde26f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbook
	// class UPaperFlipbook* GetFlipbook();                                                                                     // [0xde26c0] Native|Public|BlueprintCallable|BlueprintPure 
};
...
{ 
public:
	TArray<class UMaterialInterface*>                  InstanceMaterials;                                          // 0x0470   (0x0010)  
	TArray<FSpriteInstanceData>                        PerInstanceSpriteData;                                      // 0x0480   (0x0010)  
	unsigned char                                      UnknownData00_7[0x10];                                      // 0x0490   (0x0010)  MISSED


	/// Functions
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.UpdateInstanceTransform
	// bool UpdateInstanceTransform(int32_t InstanceIndex, FTransform& NewInstanceTransform, bool bWorldSpace, bool bMarkRenderStateDirty, bool bTeleport); // [0xde4af0] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.UpdateInstanceColor
	// bool UpdateInstanceColor(int32_t InstanceIndex, FLinearColor NewInstanceColor, bool bMarkRenderStateDirty);              // [0xde49d0] Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.SortInstancesAlongAxis
	// void SortInstancesAlongAxis(FVector WorldSpaceSortAxis);                                                                 // [0xde4920] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.RemoveInstance
	// bool RemoveInstance(int32_t InstanceIndex);                                                                              // [0xde3be0] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.GetInstanceTransform
	// bool GetInstanceTransform(int32_t InstanceIndex, FTransform& OutInstanceTransform, bool bWorldSpace);                    // [0xde27b0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.GetInstanceCount
	// int32_t GetInstanceCount();                                                                                              // [0xde2780] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.ClearInstances
	// void ClearInstances();                                                                                                   // [0xde24d0] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.AddInstance
	// int32_t AddInstance(FTransform& Transform, class UPaperSprite* Sprite, bool bWorldSpace, FLinearColor Color);            // [0xde20a0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// FSlateBrush MakeBrushFromSprite(class UPaperSprite* Sprite, int32_t Width, int32_t Height);                              // [0xde3730] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
{ 
public:
	class UPaperSprite*                                SourceSprite;                                               // 0x0470   (0x0008)  
	class UMaterialInterface*                          MaterialOverride;                                           // 0x0478   (0x0008)  
	FLinearColor                                       SpriteColor;                                                // 0x0480   (0x0010)  


	/// Functions
	// Function /Script/Paper2D.PaperSpriteComponent.SetSpriteColor
	// void SetSpriteColor(FLinearColor NewColor);                                                                              // [0xde45f0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperSpriteComponent.SetSprite
	// bool SetSprite(class UPaperSprite* NewSprite);                                                                           // [0xde3e70] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperSpriteComponent.GetSprite
	// class UPaperSprite* GetSprite();                                                                                         // [0xde26c0] Native|Public|BlueprintCallable|BlueprintPure 
};
...
/// Size: 0x04A0 (1184 bytes) (0x000448 - 0x0004A0) align 16 MaxSize: 0x04A0
class UPaperTerrainComponent : public UPrimitiveComponent
{ 
public:
	class UPaperTerrainMaterial*                       TerrainMaterial;                                            // 0x0448   (0x0008)  
	bool                                               bClosedSpline;                                              // 0x0450   (0x0001)  
	bool                                               bFilledSpline;                                              // 0x0451   (0x0001)  
	unsigned char                                      UnknownData00_6[0x6];                                       // 0x0452   (0x0006)  MISSED
	class UPaperTerrainSplineComponent*                AssociatedSpline;                                           // 0x0458   (0x0008)  
	int32_t                                            RandomSeed;                                                 // 0x0460   (0x0004)  
	float                                              SegmentOverlapAmount;                                       // 0x0464   (0x0004)  
	FLinearColor                                       TerrainColor;                                               // 0x0468   (0x0010)  
	int32_t                                            ReparamStepsPerSegment;                                     // 0x0478   (0x0004)  
	TEnumAsByte<ESpriteCollisionMode>                  SpriteCollisionDomain;                                      // 0x047C   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x047D   (0x0003)  MISSED
	float                                              CollisionThickness;                                         // 0x0480   (0x0004)  
	...
	// void SetTerrainColor(FLinearColor NewColor);                                                                             // [0xde4680] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
{ 
public:
	int32_t                                            MapWidth;                                                   // 0x0470   (0x0004)  
	int32_t                                            MapHeight;                                                  // 0x0474   (0x0004)  
	int32_t                                            TileWidth;                                                  // 0x0478   (0x0004)  
	int32_t                                            TileHeight;                                                 // 0x047C   (0x0004)  
	class UPaperTileSet*                               DefaultLayerTileSet;                                        // 0x0480   (0x0008)  
	class UMaterialInterface*                          Material;                                                   // 0x0488   (0x0008)  
	TArray<class UPaperTileLayer*>                     TileLayers;                                                 // 0x0490   (0x0010)  
	FLinearColor                                       TileMapColor;                                               // 0x04A0   (0x0010)  
	int32_t                                            UseSingleLayerIndex;                                        // 0x04B0   (0x0004)  
	bool                                               bUseSingleLayer;                                            // 0x04B4   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x04B5   (0x0003)  MISSED
	class UPaperTileMap*                               TileMap;                                                    // 0x04B8   (0x0008)  


	/// Functions
	// Function /Script/Paper2D.PaperTileMapComponent.SetTileMapColor
	// void SetTileMapColor(FLinearColor NewColor);                                                                             // [0xde4890] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetTileMap
	// bool SetTileMap(class UPaperTileMap* NewTileMap);                                                                        // [0xde3e70] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetTile
	// void SetTile(int32_t X, int32_t Y, int32_t Layer, FPaperTileInfo NewValue);                                              // [0xde4710] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetLayerColor
	// void SetLayerColor(FLinearColor NewColor, int32_t Layer);                                                                // [0xde4150] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetLayerCollision
	// void SetLayerCollision(int32_t Layer, bool bHasCollision, bool bOverrideThickness, float CustomThickness, bool bOverrideOffset, float CustomOffset, bool bRebuildCollision); // [0xde3f10] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetDefaultCollisionThickness
	// void SetDefaultCollisionThickness(float Thickness, bool bRebuildCollision);                                              // [0xde3d90] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.ResizeMap
	// void ResizeMap(int32_t NewWidthInTiles, int32_t NewHeightInTiles);                                                       // [0xde3c80] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.RebuildCollision
	// void RebuildCollision();                                                                                                 // [0xde3bc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.OwnsTileMap
	// bool OwnsTileMap();                                                                                                      // [0xde3b50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.MakeTileMapEditable
	// void MakeTileMapEditable();                                                                                              // [0xde3aa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTilePolygon
	// void GetTilePolygon(int32_t TileX, int32_t TileY, TArray<FVector>& Points, int32_t LayerIndex, bool bWorldSpace);        // [0xde3280] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileMapColor
	// FLinearColor GetTileMapColor();                                                                                          // [0xde3240] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileCornerPosition
	// FVector GetTileCornerPosition(int32_t TileX, int32_t TileY, int32_t LayerIndex, bool bWorldSpace);                       // [0xde30d0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileCenterPosition
	// FVector GetTileCenterPosition(int32_t TileX, int32_t TileY, int32_t LayerIndex, bool bWorldSpace);                       // [0xde2f60] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTile
	// FPaperTileInfo GetTile(int32_t X, int32_t Y, int32_t Layer);                                                             // [0xde2e40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetMapSize
	// void GetMapSize(int32_t& MapWidth, int32_t& MapHeight, int32_t& NumLayers);                                              // [0xde2a80] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.GetLayerColor
	// FLinearColor GetLayerColor(int32_t Layer);                                                                               // [0xde29e0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.CreateNewTileMap
	// void CreateNewTileMap(int32_t MapWidth, int32_t MapHeight, int32_t TileWidth, int32_t TileHeight, float PixelsPerUnrealUnit, bool bCreateLayer); // [0xde24f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.AddNewLayer
	// class UPaperTileLayer* AddNewLayer();                                                                                    // [0xde2270] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FPaperTileInfo MakeTile(int32_t TileIndex, class UPaperTileSet* TileSet, bool bFlipH, bool bFlipV, bool bFlipD);         // [0xde38d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.TileMapBlueprintLibrary.GetTileUserData
	// FName GetTileUserData(FPaperTileInfo Tile);                                                                              // [0xde3530] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.TileMapBlueprintLibrary.GetTileTransform
	// FTransform GetTileTransform(FPaperTileInfo Tile);                                                                        // [0xde3450] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.TileMapBlueprintLibrary.BreakTile
	// void BreakTile(FPaperTileInfo Tile, int32_t& TileIndex, class UPaperTileSet*& TileSet, bool& bFlipH, bool& bFlipV, bool& bFlipD); // [0xde22a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
static_assert(sizeof(UPaperFlipbookComponent) == 0x04C0); // 1216 bytes (0x000470 - 0x0004C0)
...
static_assert(sizeof(UPaperGroupedSpriteComponent) == 0x04A0); // 1184 bytes (0x000470 - 0x0004A0)
...
static_assert(sizeof(UPaperSpriteComponent) == 0x0490); // 1168 bytes (0x000470 - 0x000490)
static_assert(sizeof(APaperTerrainActor) == 0x0238); // 568 bytes (0x000220 - 0x000238)
static_assert(sizeof(UPaperTerrainComponent) == 0x04A0); // 1184 bytes (0x000448 - 0x0004A0)
...
static_assert(sizeof(UPaperTileMapComponent) == 0x04C0); // 1216 bytes (0x000470 - 0x0004C0)
...
static_assert(offsetof(UPaperFlipbookComponent, SourceFlipbook) == 0x0470);
static_assert(offsetof(UPaperFlipbookComponent, Material) == 0x0478);
static_assert(offsetof(UPaperFlipbookComponent, SpriteColor) == 0x0490);
static_assert(offsetof(UPaperFlipbookComponent, CachedBodySetup) == 0x04A0);
...
static_assert(offsetof(UPaperGroupedSpriteComponent, InstanceMaterials) == 0x0470);
static_assert(offsetof(UPaperGroupedSpriteComponent, PerInstanceSpriteData) == 0x0480);
...
static_assert(offsetof(UPaperSpriteComponent, SourceSprite) == 0x0470);
static_assert(offsetof(UPaperSpriteComponent, MaterialOverride) == 0x0478);
static_assert(offsetof(UPaperSpriteComponent, SpriteColor) == 0x0480);
...
static_assert(offsetof(UPaperTerrainComponent, TerrainMaterial) == 0x0448);
static_assert(offsetof(UPaperTerrainComponent, AssociatedSpline) == 0x0458);
static_assert(offsetof(UPaperTerrainComponent, TerrainColor) == 0x0468);
static_assert(offsetof(UPaperTerrainComponent, SpriteCollisionDomain) == 0x047C);
static_assert(offsetof(UPaperTerrainComponent, CachedBodySetup) == 0x0488);
...
static_assert(offsetof(UPaperTileMapComponent, DefaultLayerTileSet) == 0x0480);
static_assert(offsetof(UPaperTileMapComponent, Material) == 0x0488);
static_assert(offsetof(UPaperTileMapComponent, TileLayers) == 0x0490);
static_assert(offsetof(UPaperTileMapComponent, TileMapColor) == 0x04A0);
static_assert(offsetof(UPaperTileMapComponent, TileMap) == 0x04B8);
