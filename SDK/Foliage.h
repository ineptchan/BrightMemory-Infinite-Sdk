...
/// Size: 0x06A0 (1696 bytes) (0x000670 - 0x0006A0) align 16 MaxSize: 0x06A0
class UFoliageInstancedStaticMeshComponent : public UHierarchicalInstancedStaticMeshComponent
{ 
public:
	SDK_UNDEFINED(16,882) /* FMulticastInlineDelegate */ __um(OnInstanceTakePointDamage);                          // 0x0670   (0x0010)  
	SDK_UNDEFINED(16,883) /* FMulticastInlineDelegate */ __um(OnInstanceTakeRadialDamage);                         // 0x0680   (0x0010)  
	FGuid                                              GenerationGuid;                                             // 0x0690   (0x0010)  
};
...
public:
	...
	// int32_t FoliageOverlappingSphereCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FVector CenterPosition, float Radius); // [0x230e510] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxCount
	// int32_t FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box);          // [0x230e3d0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // [0x230e1b0] Final|Native|Protected|HasOutParms 
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x8];                                       // 0x04D8   (0x0008)  MISSED
};
...
public:
	...
	// void Simulate(int32_t NumSteps);                                                                                         // [0x230e660] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UFoliageInstancedStaticMeshComponent) == 0x06A0); // 1696 bytes (0x000670 - 0x0006A0)
...
static_assert(sizeof(UInteractiveFoliageComponent) == 0x04E0); // 1248 bytes (0x0004D8 - 0x0004E0)
...
static_assert(offsetof(UFoliageInstancedStaticMeshComponent, GenerationGuid) == 0x0690);
