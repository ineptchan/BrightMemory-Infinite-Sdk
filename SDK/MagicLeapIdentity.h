...
public:
	...
	// void RequestIdentityAttributeValueDelegate__DelegateSignature(EMagicLeapIdentityError ResultCode, TArray<FMagicLeapIdentityAttribute>& AttributeValue); // [0x148e900] Public|Delegate|HasOutParms 
	// Function /Script/MagicLeapIdentity.MagicLeapIdentity.RequestAttributeValueAsync
	// EMagicLeapIdentityError RequestAttributeValueAsync(TArray<EMagicLeapIdentityKey>& RequestedAttributeList, FDelegateProperty& ResultDelegate); // [0xf48770] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapIdentity.MagicLeapIdentity.RequestAttributeValue
	// EMagicLeapIdentityError RequestAttributeValue(TArray<EMagicLeapIdentityKey>& RequestedAttributeList, TArray<FMagicLeapIdentityAttribute>& RequestedAttributeValues); // [0xf48620] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapIdentity.MagicLeapIdentity.ModifyIdentityAttributeValueDelegate__DelegateSignature
	// void ModifyIdentityAttributeValueDelegate__DelegateSignature(EMagicLeapIdentityError ResultCode, TArray<EMagicLeapIdentityKey>& AttributesUpdatedSuccessfully); // [0x148e900] Public|Delegate|HasOutParms 
	// Function /Script/MagicLeapIdentity.MagicLeapIdentity.GetAllAvailableAttributesAsync
	// void GetAllAvailableAttributesAsync(FDelegateProperty& ResultDelegate);                                                  // [0xf48570] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapIdentity.MagicLeapIdentity.GetAllAvailableAttributes
	// EMagicLeapIdentityError GetAllAvailableAttributes(TArray<EMagicLeapIdentityKey>& AvailableAttributes);                   // [0xf484b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapIdentity.MagicLeapIdentity.AvailableIdentityAttributesDelegate__DelegateSignature
	// void AvailableIdentityAttributesDelegate__DelegateSignature(EMagicLeapIdentityError ResultCode, TArray<EMagicLeapIdentityKey>& AvailableAttributes); // [0x148e900] Public|Delegate|HasOutParms 
};
