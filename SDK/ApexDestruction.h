...
public:
	...
	SDK_UNDEFINED(16,282) /* FMulticastInlineDelegate */ __um(OnActorFracture);                                    // 0x0228   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,283) /* FMulticastInlineDelegate */ __um(OnComponentFracture);                                // 0x06D0   (0x0010)  
	...
	// void SetDestructibleMesh(class UDestructibleMesh* NewMesh);                                                              // [0x7bb690] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.GetDestructibleMesh
	// class UDestructibleMesh* GetDestructibleMesh();                                                                          // [0x7bb660] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyRadiusDamage
	// void ApplyRadiusDamage(float BaseDamage, FVector& HurtOrigin, float DamageRadius, float ImpulseStrength, bool bFullDamage); // [0x7bb4a0] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyDamage
	// void ApplyDamage(float DamageAmount, FVector& HitLocation, FVector& ImpulseDir, float ImpulseStrength);                  // [0x7bb320] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x0438 (1080 bytes) (0x000398 - 0x000438) align 8 MaxSize: 0x0438
class UDestructibleMesh : public USkeletalMesh
{ 
public:
	FDestructibleParameters                            DefaultDestructibleParameters;                              // 0x0398   (0x0088)  
	TArray<FFractureEffect>                            FractureEffects;                                            // 0x0420   (0x0010)  
	unsigned char                                      UnknownData00_7[0x8];                                       // 0x0430   (0x0008)  MISSED
};
...
static_assert(sizeof(UDestructibleMesh) == 0x0438); // 1080 bytes (0x000398 - 0x000438)
...
static_assert(offsetof(UDestructibleMesh, DefaultDestructibleParameters) == 0x0398);
static_assert(offsetof(UDestructibleMesh, FractureEffects) == 0x0420);
