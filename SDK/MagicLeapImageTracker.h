...
public:
	...
	SDK_UNDEFINED(16,945) /* FMulticastInlineDelegate */ __um(OnSetImageTargetSucceeded);                          // 0x0218   (0x0010)  
	SDK_UNDEFINED(16,946) /* FMulticastInlineDelegate */ __um(OnSetImageTargetFailed);                             // 0x0228   (0x0010)  
	SDK_UNDEFINED(16,947) /* FMulticastInlineDelegate */ __um(OnImageTargetFound);                                 // 0x0238   (0x0010)  
	SDK_UNDEFINED(16,948) /* FMulticastInlineDelegate */ __um(OnImageTargetLost);                                  // 0x0248   (0x0010)  
	SDK_UNDEFINED(16,949) /* FMulticastInlineDelegate */ __um(OnImageTargetUnreliableTracking);                    // 0x0258   (0x0010)  
	...
	// bool SetTargetAsync(class UTexture2D* ImageTarget);                                                                      // [0xf4c200] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeapImageTracker.MagicLeapImageTrackerComponent.RemoveTargetAsync
	// bool RemoveTargetAsync();                                                                                                // [0xf4c150] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetMaxSimultaneousTargets(int32_t MaxSimultaneousTargets);                                                          // [0xf4c180] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.IsImageTrackingEnabled
	// bool IsImageTrackingEnabled();                                                                                           // [0xf4c120] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.GetMaxSimultaneousTargets
	// int32_t GetMaxSimultaneousTargets();                                                                                     // [0xf4c0f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.EnableImageTracking
	// void EnableImageTracking(bool bEnable);                                                                                  // [0xf4c070] Final|Native|Static|Public|BlueprintCallable 
};
