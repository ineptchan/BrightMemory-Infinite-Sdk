...
public:
	...
	SDK_UNDEFINED(16,900) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,901) /* TScriptInterface<Class> */ __um(AngleSource);                                         // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,902) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,903) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,904) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,905) /* TScriptInterface<Class> */ __um(ParameterSource);                                     // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,906) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,907) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
...
{ 
	unsigned char                                      UnknownData00_2[0xAC];                                      // 0x0000   (0x00AC)  MISSED
};
...
/// Size: 0x0470 (1136 bytes) (0x000448 - 0x000470) align 16 MaxSize: 0x0468
class UGizmoBaseComponent : public UPrimitiveComponent
{ 
public:
	FLinearColor                                       Color;                                                      // 0x0448   (0x0010)  
	float                                              HoverSizeMultiplier;                                        // 0x0458   (0x0004)  
	float                                              PixelHitDistanceThreshold;                                  // 0x045C   (0x0004)  
	unsigned char                                      UnknownData00_7[0x8];                                       // 0x0460   (0x0008)  MISSED


	/// Functions
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState
	// void UpdateWorldLocalState(bool bWorldIn);                                                                               // [0x3272f00] Final|Native|Public  
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState
	// void UpdateHoverState(bool bHoveringIn);                                                                                 // [0x3272e70] Final|Native|Public  
};
...
{ 
public:
	FVector                                            Direction;                                                  // 0x0468   (0x000C)  
	float                                              Gap;                                                        // 0x0474   (0x0004)  
	float                                              Length;                                                     // 0x0478   (0x0004)  
	float                                              Thickness;                                                  // 0x047C   (0x0004)  
	unsigned char                                      UnknownData00_7[0x10];                                      // 0x0480   (0x0010)  MISSED
};
...
{ 
public:
	FVector                                            Origin;                                                     // 0x0468   (0x000C)  
	unsigned char                                      UnknownData00_6[0xC];                                       // 0x0474   (0x000C)  MISSED
...
{ 
public:
	FVector                                            Normal;                                                     // 0x0468   (0x000C)  
	float                                              Radius;                                                     // 0x0474   (0x0004)  
	float                                              Thickness;                                                  // 0x0478   (0x0004)  
	int32_t                                            NumSides;                                                   // 0x047C   (0x0004)  
	bool                                               bViewAligned;                                               // 0x0480   (0x0001)  
	bool                                               bOnlyAllowFrontFacingHits;                                  // 0x0481   (0x0001)  
	unsigned char                                      UnknownData00_7[0xE];                                       // 0x0482   (0x000E)  MISSED
};
...
public:
	...
	// void SetTransform(FTransform& NewTransform);                                                                             // [0x3272d00] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoTransformSource.GetTransform
	// FTransform GetTransform();                                                                                               // [0x3272b50] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// bool HasTangentVectors();                                                                                                // [0x3272bc0] Native|Public|Const  
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors
	// void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut);                                                      // [0x3272a60] Native|Public|HasOutParms|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetOrigin
	// FVector GetOrigin();                                                                                                     // [0x32729b0] Native|Public|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetDirection
	// FVector GetDirection();                                                                                                  // [0x3272970] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// void UpdateHoverState(bool bHovering);                                                                                   // [0x3272de0] Native|Public|Const  
};
...
public:
	...
	// void EndUpdate();                                                                                                        // [0x3272910] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoStateTarget.BeginUpdate
	// void BeginUpdate();                                                                                                      // [0x3272930] Native|Public        
};
...
public:
	...
	// void SetParameter(FVector2D& NewValue);                                                                                  // [0x3272c70] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter
	// FVector2D GetParameter();                                                                                                // [0x3272a20] Native|Public|HasDefaults|Const 
...
public:
	FVector                                            Normal;                                                     // 0x0468   (0x000C)  
	float                                              HandleSize;                                                 // 0x0474   (0x0004)  
	float                                              Thickness;                                                  // 0x0478   (0x0004)  
	FVector                                            Direction;                                                  // 0x047C   (0x000C)  
	float                                              Length;                                                     // 0x0488   (0x0004)  
	bool                                               bImageScale;                                                // 0x048C   (0x0001)  
	unsigned char                                      UnknownData00_7[0x3];                                       // 0x048D   (0x0003)  MISSED
};
...
{ 
public:
	FVector                                            DirectionX;                                                 // 0x0468   (0x000C)  
	FVector                                            DirectionY;                                                 // 0x0474   (0x000C)  
	float                                              OffsetX;                                                    // 0x0480   (0x0004)  
	float                                              OffsetY;                                                    // 0x0484   (0x0004)  
	float                                              LengthX;                                                    // 0x0488   (0x0004)  
	float                                              LengthY;                                                    // 0x048C   (0x0004)  
	float                                              Thickness;                                                  // 0x0490   (0x0004)  
	char                                               SegmentFlags;                                               // 0x0494   (0x0001)  
...
{ 
public:
	SDK_UNDEFINED(16,908) /* TScriptInterface<Class> */ __um(FloatParameterSource);                                // 0x0048   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,909) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,910) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,911) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,912) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,913) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,914) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,915) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,916) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x0058   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,917) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,918) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x0058   (0x0010)  
	float                                              ScaleMultiplier;                                            // 0x0068   (0x0004)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,919) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,920) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,921) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,922) /* TScriptInterface<Class> */ __um(ParameterSource);                                     // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,923) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,924) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
	bool                                               bEnableSignedAxis;                                          // 0x0088   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,925) /* TScriptInterface<Class> */ __um(TransactionManager);                                  // 0x0050   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,926) /* TScriptInterface<Class> */ __um(ChildTransformSource);                                // 0x0048   (0x0010)  
...
static_assert(sizeof(UGizmoBaseComponent) == 0x0468); // 1128 bytes (0x000448 - 0x000468)
static_assert(sizeof(UGizmoArrowComponent) == 0x0490); // 1168 bytes (0x000468 - 0x000490)
static_assert(sizeof(UGizmoBoxComponent) == 0x04B0); // 1200 bytes (0x000468 - 0x0004B0)
static_assert(sizeof(UGizmoCircleComponent) == 0x0490); // 1168 bytes (0x000468 - 0x000490)
...
static_assert(sizeof(UGizmoLineHandleComponent) == 0x0490); // 1168 bytes (0x000468 - 0x000490)
static_assert(sizeof(UGizmoRectangleComponent) == 0x04A0); // 1184 bytes (0x000468 - 0x0004A0)
...
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x0448);
static_assert(offsetof(UGizmoArrowComponent, Direction) == 0x0468);
static_assert(offsetof(UGizmoBoxComponent, Origin) == 0x0468);
static_assert(offsetof(UGizmoBoxComponent, Rotation) == 0x0480);
static_assert(offsetof(UGizmoBoxComponent, Dimensions) == 0x0490);
static_assert(offsetof(UGizmoCircleComponent, Normal) == 0x0468);
static_assert(offsetof(UGizmoLineHandleComponent, Normal) == 0x0468);
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x047C);
static_assert(offsetof(UGizmoRectangleComponent, DirectionX) == 0x0468);
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x0474);
