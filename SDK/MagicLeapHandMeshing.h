...
public:
	...
	// void SetUseWeightedNormals(bool bInUseWeightedNormals);                                                                  // [0xf52760] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeapHandMeshing.MagicLeapHandMeshingComponent.DisconnectMRMesh
	// bool DisconnectMRMesh(class UMRMeshComponent* InMRMeshPtr);                                                              // [0xf52630] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeapHandMeshing.MagicLeapHandMeshingComponent.ConnectMRMesh
	// bool ConnectMRMesh(class UMRMeshComponent* InMRMeshPtr);                                                                 // [0xf524a0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool DisconnectMRMesh(class UMRMeshComponent* InMRMeshPtr);                                                              // [0xf526d0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapHandMeshing.MagicLeapHandMeshingFunctionLibrary.DestroyClient
	// bool DestroyClient();                                                                                                    // [0xf52600] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapHandMeshing.MagicLeapHandMeshingFunctionLibrary.CreateClient
	// bool CreateClient();                                                                                                     // [0xf525d0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapHandMeshing.MagicLeapHandMeshingFunctionLibrary.ConnectMRMesh
	// bool ConnectMRMesh(class UMRMeshComponent* InMRMeshPtr);                                                                 // [0xf52540] Final|Native|Static|Public|BlueprintCallable 
};
