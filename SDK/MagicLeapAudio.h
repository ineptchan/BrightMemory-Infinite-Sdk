...
public:
	...
	// bool SetOnAudioJackUnpluggedDelegate(FDelegateProperty& ResultDelegate);                                                 // [0xf34cd0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapAudio.MagicLeapAudioFunctionLibrary.SetOnAudioJackPluggedDelegate
	// bool SetOnAudioJackPluggedDelegate(FDelegateProperty& ResultDelegate);                                                   // [0xf34c20] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapAudio.MagicLeapAudioFunctionLibrary.SetMicMute
	// bool SetMicMute(bool IsMuted);                                                                                           // [0xf34b90] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapAudio.MagicLeapAudioFunctionLibrary.IsMicMuted
	// bool IsMicMuted();                                                                                                       // [0xf34b60] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
