...
public:
	...
	// class USplineComponent* GetRailSplineComponent();                                                                        // [0x25f3b10] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
/// Size: 0x0930 (2352 bytes) (0x0008D0 - 0x000930) align 16 MaxSize: 0x0930
class ACineCameraActor : public ACameraActor
{ 
public:
	FCameraLookatTrackingSettings                      LookatTrackingSettings;                                     // 0x08D0   (0x0050)  
	unsigned char                                      UnknownData00_7[0x10];                                      // 0x0920   (0x0010)  MISSED


	/// Functions
	// Function /Script/CinematicCamera.CineCameraActor.GetCineCameraComponent
	// class UCineCameraComponent* GetCineCameraComponent();                                                                    // [0x25f3740] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x09F0 (2544 bytes) (0x0008F0 - 0x0009F0) align 16 MaxSize: 0x09F0
class UCineCameraComponent : public UCameraComponent
{ 
public:
	FCameraFilmbackSettings                            FilmbackSettings;                                           // 0x08F0   (0x000C)  
	FCameraFilmbackSettings                            Filmback;                                                   // 0x08FC   (0x000C)  
	FCameraLensSettings                                LensSettings;                                               // 0x0908   (0x0018)  
	FCameraFocusSettings                               FocusSettings;                                              // 0x0920   (0x0058)  
	float                                              CurrentFocalLength;                                         // 0x0978   (0x0004)  
	float                                              CurrentAperture;                                            // 0x097C   (0x0004)  
	float                                              CurrentFocusDistance;                                       // 0x0980   (0x0004)  
	unsigned char                                      UnknownData00_6[0xC];                                       // 0x0984   (0x000C)  MISSED
	TArray<FNamedFilmbackPreset>                       FilmbackPresets;                                            // 0x0990   (0x0010)  
	TArray<FNamedLensPreset>                           LensPresets;                                                // 0x09A0   (0x0010)  
	FString                                            DefaultFilmbackPresetName;                                  // 0x09B0   (0x0010)  
	FString                                            DefaultFilmbackPreset;                                      // 0x09C0   (0x0010)  
	FString                                            DefaultLensPresetName;                                      // 0x09D0   (0x0010)  
	float                                              DefaultLensFocalLength;                                     // 0x09E0   (0x0004)  
	float                                              DefaultLensFStop;                                           // 0x09E4   (0x0004)  
	unsigned char                                      UnknownData01_7[0x8];                                       // 0x09E8   (0x0008)  MISSED


	/// Functions
	// Function /Script/CinematicCamera.CineCameraComponent.SetLensPresetByName
	// void SetLensPresetByName(FString InPresetName);                                                                          // [0x25f3c80] Final|Native|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.SetFilmbackPresetByName
	// void SetFilmbackPresetByName(FString InPresetName);                                                                      // [0x25f3be0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.SetCurrentFocalLength
	// void SetCurrentFocalLength(float InFocalLength);                                                                         // [0x25f3b60] Final|Native|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetVerticalFieldOfView
	// float GetVerticalFieldOfView();                                                                                          // [0x25f3b30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetLensPresetsCopy
	// TArray<FNamedLensPreset> GetLensPresetsCopy();                                                                           // [0x25f3a30] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetLensPresetName
	// FString GetLensPresetName();                                                                                             // [0x25f39b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetHorizontalFieldOfView
	// float GetHorizontalFieldOfView();                                                                                        // [0x25f3980] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetFilmbackPresetsCopy
	// TArray<FNamedFilmbackPreset> GetFilmbackPresetsCopy();                                                                   // [0x25f38a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetFilmbackPresetName
	// FString GetFilmbackPresetName();                                                                                         // [0x25f3820] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetDefaultFilmbackPresetName
	// FString GetDefaultFilmbackPresetName();                                                                                  // [0x25f3760] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
static_assert(sizeof(ACineCameraActor) == 0x0930); // 2352 bytes (0x0008D0 - 0x000930)
...
static_assert(sizeof(UCineCameraComponent) == 0x09F0); // 2544 bytes (0x0008F0 - 0x0009F0)
...
static_assert(offsetof(ACineCameraActor, LookatTrackingSettings) == 0x08D0);
...
static_assert(offsetof(UCineCameraComponent, FilmbackSettings) == 0x08F0);
static_assert(offsetof(UCineCameraComponent, Filmback) == 0x08FC);
static_assert(offsetof(UCineCameraComponent, LensSettings) == 0x0908);
static_assert(offsetof(UCineCameraComponent, FocusSettings) == 0x0920);
static_assert(offsetof(UCineCameraComponent, FilmbackPresets) == 0x0990);
static_assert(offsetof(UCineCameraComponent, LensPresets) == 0x09A0);
static_assert(offsetof(UCineCameraComponent, DefaultFilmbackPresetName) == 0x09B0);
static_assert(offsetof(UCineCameraComponent, DefaultFilmbackPreset) == 0x09C0);
static_assert(offsetof(UCineCameraComponent, DefaultLensPresetName) == 0x09D0);
