...
public:
	...
	SDK_UNDEFINED(16,950) /* FMulticastInlineDelegate */ __um(OnPlanesQueryResult);                                // 0x0228   (0x0010)  
	SDK_UNDEFINED(16,951) /* FMulticastInlineDelegate */ __um(OnPersistentPlanesQueryResult);                      // 0x0238   (0x0010)  
	...
	// bool RequestPlanesAsync();                                                                                               // [0xf4f0e0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void ReorderPlaneFlags(TArray<EMagicLeapPlaneQueryFlags>& InPriority, TArray<EMagicLeapPlaneQueryFlags>& InFlagsToReorder, TArray<EMagicLeapPlaneQueryFlags>& OutReorderedFlags); // [0xf4ef60] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.RemovePersistentQuery
	// bool RemovePersistentQuery(FGuid Handle);                                                                                // [0xf4eec0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.RemoveFlagsNotInQuery
	// void RemoveFlagsNotInQuery(TArray<EMagicLeapPlaneQueryFlags>& InQueryFlags, TArray<EMagicLeapPlaneQueryFlags>& InResultFlags, TArray<EMagicLeapPlaneQueryFlags>& OutFlags); // [0xf4ed40] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.PlanesQueryBeginAsync
	// bool PlanesQueryBeginAsync(FMagicLeapPlanesQuery& Query, FDelegateProperty& ResultDelegate);                             // [0xf4ebe0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.PlanesPersistentQueryBeginAsync
	// bool PlanesPersistentQueryBeginAsync(FMagicLeapPlanesQuery& Query, FGuid& Handle, FDelegateProperty& ResultDelegate);    // [0xf4ea30] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.IsTrackerValid
	// bool IsTrackerValid();                                                                                                   // [0xf4ea00] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.GetContentScale
	// FTransform GetContentScale(class AActor* ContentActor, FMagicLeapPlaneResult& PlaneResult);                              // [0xf4e8b0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.DestroyTracker
	// bool DestroyTracker();                                                                                                   // [0xf4e880] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.CreateTracker
	// bool CreateTracker();                                                                                                    // [0xf4e850] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.AddPersistentQuery
	// FGuid AddPersistentQuery(EMagicLeapPlaneQueryType PersistentQueryType);                                                  // [0xf4e7c0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
