...
{ 
public:
	SDK_UNDEFINED(16,928) /* FMulticastInlineDelegate */ __um(InAppPurchaseLogMessage);                            // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,929) /* FMulticastInlineDelegate */ __um(GetItemsDetailsSuccess);                             // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,930) /* FMulticastInlineDelegate */ __um(GetItemsDetailsFailure);                             // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,931) /* FMulticastInlineDelegate */ __um(PurchaseConfirmationSuccess);                        // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,932) /* FMulticastInlineDelegate */ __um(PurchaseConfirmationFailure);                        // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,933) /* FMulticastInlineDelegate */ __um(GetPurchaseHistorySuccess);                          // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,934) /* FMulticastInlineDelegate */ __um(GetPurchaseHistoryFailure);                          // 0x0110   (0x0010)  
	...
	// bool TryPurchaseItemAsync(FPurchaseItemDetails& ItemDetails);                                                            // [0xf2c7b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeap.InAppPurchaseComponent.TryGetPurchaseHistoryAsync
	// bool TryGetPurchaseHistoryAsync(int32_t InNumPages);                                                                     // [0xf2c710] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.InAppPurchaseComponent.TryGetItemsDetailsAsync
	// bool TryGetItemsDetailsAsync(TArray<FString>& ItemIDs);                                                                  // [0xf2c630] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeap.InAppPurchaseComponent.PurchaseConfirmationSuccess__DelegateSignature
	// void PurchaseConfirmationSuccess__DelegateSignature(FPurchaseConfirmation& PurchaseConfirmations);                       // [0x148e900] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MagicLeap.InAppPurchaseComponent.PurchaseConfirmationFailure__DelegateSignature
	// void PurchaseConfirmationFailure__DelegateSignature();                                                                   // [0x148e900] MulticastDelegate|Public|Delegate 
	// Function /Script/MagicLeap.InAppPurchaseComponent.InAppPurchaseLogMessage__DelegateSignature
	// void InAppPurchaseLogMessage__DelegateSignature(FString LogMessage);                                                     // [0x148e900] MulticastDelegate|Public|Delegate 
	// Function /Script/MagicLeap.InAppPurchaseComponent.GetPurchaseHistorySuccess__DelegateSignature
	// void GetPurchaseHistorySuccess__DelegateSignature(TArray<FPurchaseConfirmation>& PurchaseHistory);                       // [0x148e900] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MagicLeap.InAppPurchaseComponent.GetPurchaseHistoryFailure__DelegateSignature
	// void GetPurchaseHistoryFailure__DelegateSignature();                                                                     // [0x148e900] MulticastDelegate|Public|Delegate 
	// Function /Script/MagicLeap.InAppPurchaseComponent.GetItemsDetailsSuccess__DelegateSignature
	// void GetItemsDetailsSuccess__DelegateSignature(TArray<FPurchaseItemDetails>& ItemsDetails);                              // [0x148e900] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MagicLeap.InAppPurchaseComponent.GetItemsDetailsFailure__DelegateSignature
	// void GetItemsDetailsFailure__DelegateSignature();                                                                        // [0x148e900] MulticastDelegate|Public|Delegate 
};
...
{ 
public:
	SDK_UNDEFINED(16,935) /* FMulticastInlineDelegate */ __um(DeviceHasReactivatedDelegate);                       // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,936) /* FMulticastInlineDelegate */ __um(DeviceWillEnterRealityModeDelegate);                 // 0x0150   (0x0010)  
	SDK_UNDEFINED(16,937) /* FMulticastInlineDelegate */ __um(DeviceWillGoInStandbyDelegate);                      // 0x0160   (0x0010)  
	SDK_UNDEFINED(16,938) /* FMulticastInlineDelegate */ __um(FocusLostDelegate);                                  // 0x0170   (0x0010)  
	SDK_UNDEFINED(16,939) /* FMulticastInlineDelegate */ __um(FocusGainedDelegate);                                // 0x0180   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,940) /* FMulticastInlineDelegate */ __um(OnHeadTrackingLost);                                 // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,941) /* FMulticastInlineDelegate */ __um(OnHeadTrackingRecovered);                            // 0x0150   (0x0010)  
	SDK_UNDEFINED(16,942) /* FMulticastInlineDelegate */ __um(OnHeadTrackingRecoveryFailed);                       // 0x0160   (0x0010)  
	SDK_UNDEFINED(16,943) /* FMulticastInlineDelegate */ __um(OnHeadTrackingNewSessionStarted);                    // 0x0170   (0x0010)  
...
public:
	...
	// void SetStabilizationDepthActor(class AActor* InStabilizationDepthActor, bool bSetFocusActor);                           // [0xf2c570] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetFocusActor
	// void SetFocusActor(class AActor* InFocusActor, bool bSetStabilizationActor);                                             // [0xf2c4b0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetBaseRotation
	// void SetBaseRotation(FRotator& InBaseRotation);                                                                          // [0xf2c430] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetBasePosition
	// void SetBasePosition(FVector& InBasePosition);                                                                           // [0xf2c430] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetBaseOrientation
	// void SetBaseOrientation(FQuat& InBaseOrientation);                                                                       // [0xf2c430] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetAppReady
	// bool SetAppReady();                                                                                                      // [0x8eec20] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.IsRunningOnMagicLeapHMD
	// bool IsRunningOnMagicLeapHMD();                                                                                          // [0xf2bdd0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetPlatformAPILevel
	// int32_t GetPlatformAPILevel();                                                                                           // [0xf2bd40] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMLSDKVersionRevision
	// int32_t GetMLSDKVersionRevision();                                                                                       // [0xf2bd40] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMLSDKVersionMinor
	// int32_t GetMLSDKVersionMinor();                                                                                          // [0xf2bd40] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMLSDKVersionMajor
	// int32_t GetMLSDKVersionMajor();                                                                                          // [0xf2bd40] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMLSDKVersion
	// FString GetMLSDKVersion();                                                                                               // [0xf2bcc0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMinimumAPILevel
	// int32_t GetMinimumAPILevel();                                                                                            // [0xf2bd70] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetHeadTrackingState
	// bool GetHeadTrackingState(FMagicLeapHeadTrackingState& State);                                                           // [0xf2bc30] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetHeadTrackingMapEvents
	// bool GetHeadTrackingMapEvents(TSet<EMagicLeapHeadTrackingMapEvent>& MapEvents);                                          // [0xf2baf0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetGraphicsClientPerformanceInfo
	// bool GetGraphicsClientPerformanceInfo(FMagicLeapGraphicsClientPerformanceInfo& PerformanceInfo);                         // [0xf2ba40] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(16,944) /* FMulticastInlineDelegate */ __um(OnMeshTrackerUpdated);                               // 0x0200   (0x0010)  
	...
	// void SelectMeshBlocks(FMagicLeapTrackingMeshInfo& NewMeshInfo, TArray<FMagicLeapMeshBlockRequest>& RequestedMesh);       // [0xf2c310] Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.OnMeshTrackerUpdated__DelegateSignature
	// void OnMeshTrackerUpdated__DelegateSignature(FGuid ID, TArray<FVector>& Vertices, TArray<int32_t>& Triangles, TArray<FVector>& Normals, TArray<float>& Confidence); // [0x148e900] MulticastDelegate|Public|Delegate|HasOutParms|HasDefaults 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.GetNumQueuedBlockUpdates
	// int32_t GetNumQueuedBlockUpdates();                                                                                      // [0xf2bda0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.DisconnectMRMesh
	// void DisconnectMRMesh(class UMRMeshComponent* InMRMeshPtr);                                                              // [0xf2b9b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.DisconnectBlockSelector
	// void DisconnectBlockSelector();                                                                                          // [0xf2b990] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.ConnectMRMesh
	// void ConnectMRMesh(class UMRMeshComponent* InMRMeshPtr);                                                                 // [0xf2b900] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.ConnectBlockSelector
	// void ConnectBlockSelector(TScriptInterface<Class> Selector);                                                             // [0xf2b860] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SelectMeshBlocks(FMagicLeapTrackingMeshInfo& NewMeshInfo, TArray<FMagicLeapMeshBlockRequest>& RequestedMesh);       // [0xf2c1f0] Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// bool RequestRaycast(FMagicLeapRaycastQueryParams& RequestParams, FDelegateProperty& ResultDelegate);                     // [0xf2c0b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapRaycastComponent.RaycastResultDelegate__DelegateSignature
	// void RaycastResultDelegate__DelegateSignature(FMagicLeapRaycastHitResult HitResult);                                     // [0x148e900] Public|Delegate      
};
...
public:
	...
	// FMagicLeapRaycastQueryParams MakeRaycastQueryParams(FVector Position, FVector Direction, FVector UpVector, int32_t Width, int32_t Height, float HorizontalFovDegrees, bool CollideWithUnobserved, int32_t UserData); // [0xf2be00] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
