...
{ 
public:
	SDK_UNDEFINED(80,865) /* TSet<FName> */            __um(Layers);                                               // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,866) /* TSet<FName> */            __um(Tags);                                                 // 0x0080   (0x0050)  
};
...
public:
	...
	// FString GetDatasmithUserDataValueForKey(class UObject* Object, FName Key);                                               // [0xdfd580] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue
	// void GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, FString StringToMatch, TArray<FName>& OutKeys, TArray<FString>& OutValues); // [0xdfd3c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData
	// class UDatasmithAssetUserData* GetDatasmithUserData(class UObject* Object);                                              // [0xdfd330] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void PlayLevelSequence(class ULevelSequence* SequenceToPlay);                                                            // [0xdfd690] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x0030   (0x0004)  MISSED
...
public:
	...
	SDK_UNDEFINED(80,867) /* TMap<FName, TWeakObjectPtr<UTexture*>> */ __um(TextureParameterValues);               // 0x00F8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,868) /* TMap<FName, TWeakObjectPtr<AActor*>> */ __um(RelatedActors);                          // 0x0228   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,869) /* TSet<FName> */            __um(Tags);                                                 // 0x0098   (0x0050)  
