...
public:
	...
	SDK_UNDEFINED(80,871) /* TSet<AChaosSolverActor*> */ __um(ChaosSolverActors);                                  // 0x0248   (0x0050)  
	SDK_UNDEFINED(80,872) /* TSet<AGeometryCollectionActor*> */ __um(GeometryCollectionActors);                    // 0x0298   (0x0050)  
	SDK_UNDEFINED(16,873) /* FMulticastInlineDelegate */ __um(OnCollisionEvents);                                  // 0x02E8   (0x0010)  
	SDK_UNDEFINED(16,874) /* FMulticastInlineDelegate */ __um(OnBreakingEvents);                                   // 0x02F8   (0x0010)  
	SDK_UNDEFINED(16,875) /* FMulticastInlineDelegate */ __um(OnTrailingEvents);                                   // 0x0308   (0x0010)  
	...
	// void SortTrailingEvents(TArray<FChaosTrailingEventData>& TrailingEvents, EChaosTrailingSortMethod SortMethod);           // [0x324e360] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SortCollisionEvents
	// void SortCollisionEvents(TArray<FChaosCollisionEventData>& CollisionEvents, EChaosCollisionSortMethod SortMethod);       // [0x324e260] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SortBreakingEvents
	// void SortBreakingEvents(TArray<FChaosBreakingEventData>& BreakingEvents, EChaosBreakingSortMethod SortMethod);           // [0x324e160] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetTrailingEventRequestSettings
	// void SetTrailingEventRequestSettings(FChaosTrailingEventRequestSettings& InSettings);                                    // [0x324e0c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetTrailingEventEnabled
	// void SetTrailingEventEnabled(bool BIsEnabled);                                                                           // [0x324e030] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetCollisionEventRequestSettings
	// void SetCollisionEventRequestSettings(FChaosCollisionEventRequestSettings& InSettings);                                  // [0x324df00] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetCollisionEventEnabled
	// void SetCollisionEventEnabled(bool BIsEnabled);                                                                          // [0x324de70] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetBreakingEventRequestSettings
	// void SetBreakingEventRequestSettings(FChaosBreakingEventRequestSettings& InSettings);                                    // [0x324ddd0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetBreakingEventEnabled
	// void SetBreakingEventEnabled(bool BIsEnabled);                                                                           // [0x324dd40] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.RemoveGeometryCollectionActor
	// void RemoveGeometryCollectionActor(class AGeometryCollectionActor* GeometryCollectionActor);                             // [0x324dcb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.RemoveChaosSolverActor
	// void RemoveChaosSolverActor(class AChaosSolverActor* ChaosSolverActor);                                                  // [0x23484a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.IsEventListening
	// bool IsEventListening();                                                                                                 // [0x324d9c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.AddGeometryCollectionActor
	// void AddGeometryCollectionActor(class AGeometryCollectionActor* GeometryCollectionActor);                                // [0x324d6d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.AddChaosSolverActor
	// void AddChaosSolverActor(class AChaosSolverActor* ChaosSolverActor);                                                     // [0x23484a0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool RaycastSingle(FVector Start, FVector End, FHitResult& OutHit);                                                      // [0x324db30] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x0900 (2304 bytes) (0x000470 - 0x000900) align 16 MaxSize: 0x0900
class UGeometryCollectionComponent : public UMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0470   (0x0008)  MISSED
	class AChaosSolverActor*                           ChaosSolverActor;                                           // 0x0478   (0x0008)  
	unsigned char                                      UnknownData01_6[0xE0];                                      // 0x0480   (0x00E0)  MISSED
	class UGeometryCollection*                         RestCollection;                                             // 0x0560   (0x0008)  
	TArray<class AFieldSystemActor*>                   InitializationFields;                                       // 0x0568   (0x0010)  
	bool                                               Simulating;                                                 // 0x0578   (0x0001)  
	unsigned char                                      UnknownData02_6[0x7];                                       // 0x0579   (0x0007)  MISSED
	EObjectStateTypeEnum                               ObjectType;                                                 // 0x0580   (0x0001)  
	bool                                               EnableClustering;                                           // 0x0581   (0x0001)  
	unsigned char                                      UnknownData03_6[0x2];                                       // 0x0582   (0x0002)  MISSED
	int32_t                                            ClusterGroupIndex;                                          // 0x0584   (0x0004)  
	int32_t                                            MaxClusterLevel;                                            // 0x0588   (0x0004)  
	unsigned char                                      UnknownData04_6[0x4];                                       // 0x058C   (0x0004)  MISSED
	TArray<float>                                      DamageThreshold;                                            // 0x0590   (0x0010)  
	EClusterConnectionTypeEnum                         ClusterConnectionType;                                      // 0x05A0   (0x0001)  
	unsigned char                                      UnknownData05_6[0x3];                                       // 0x05A1   (0x0003)  MISSED
	int32_t                                            CollisionGroup;                                             // 0x05A4   (0x0004)  
	float                                              CollisionSampleFraction;                                    // 0x05A8   (0x0004)  
	float                                              LinearEtherDrag;                                            // 0x05AC   (0x0004)  
	float                                              AngularEtherDrag;                                           // 0x05B0   (0x0004)  
	unsigned char                                      UnknownData06_6[0x4];                                       // 0x05B4   (0x0004)  MISSED
	class UChaosPhysicalMaterial*                      PhysicalMaterial;                                           // 0x05B8   (0x0008)  
	EInitialVelocityTypeEnum                           InitialVelocityType;                                        // 0x05C0   (0x0001)  
	unsigned char                                      UnknownData07_6[0x3];                                       // 0x05C1   (0x0003)  MISSED
	FVector                                            InitialLinearVelocity;                                      // 0x05C4   (0x000C)  
	FVector                                            InitialAngularVelocity;                                     // 0x05D0   (0x000C)  
	unsigned char                                      UnknownData08_6[0x4];                                       // 0x05DC   (0x0004)  MISSED
	class UPhysicalMaterial*                           PhysicalMaterialOverride;                                   // 0x05E0   (0x0008)  
	FGeomComponentCacheParameters                      CacheParameters;                                            // 0x05E8   (0x0050)  
	SDK_UNDEFINED(16,876) /* FMulticastInlineDelegate */ __um(NotifyGeometryCollectionPhysicsStateChange);         // 0x0638   (0x0010)  
	SDK_UNDEFINED(16,877) /* FMulticastInlineDelegate */ __um(NotifyGeometryCollectionPhysicsLoadingStateChange);  // 0x0648   (0x0010)  
	unsigned char                                      UnknownData09_6[0x18];                                      // 0x0658   (0x0018)  MISSED
	SDK_UNDEFINED(16,878) /* FMulticastInlineDelegate */ __um(OnChaosBreakEvent);                                  // 0x0670   (0x0010)  
	float                                              DesiredCacheTime;                                           // 0x0680   (0x0004)  
	bool                                               CachePlayback;                                              // 0x0684   (0x0001)  
	unsigned char                                      UnknownData10_6[0x3];                                       // 0x0685   (0x0003)  MISSED
	SDK_UNDEFINED(16,879) /* FMulticastInlineDelegate */ __um(OnChaosPhysicsCollision);                            // 0x0688   (0x0010)  
	bool                                               bNotifyBreaks;                                              // 0x0698   (0x0001)  
	bool                                               bNotifyCollisions;                                          // 0x0699   (0x0001)  
	bool                                               bEnableReplication;                                         // 0x069A   (0x0001)  
	bool                                               bEnableAbandonAfterLevel;                                   // 0x069B   (0x0001)  
	int32_t                                            ReplicationAbandonClusterLevel;                             // 0x069C   (0x0004)  
	FGeometryCollectionRepData                         RepData;                                                    // 0x06A0   (0x0018)  
	unsigned char                                      UnknownData11_6[0x218];                                     // 0x06B8   (0x0218)  MISSED
	class UBodySetup*                                  DummyBodySetup;                                             // 0x08D0   (0x0008)  
	unsigned char                                      UnknownData12_7[0x28];                                      // 0x08D8   (0x0028)  MISSED


	/// Functions
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.SetNotifyBreaks
	// void SetNotifyBreaks(bool bNewNotifyBreaks);                                                                             // [0x324dfa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.ReceivePhysicsCollision
	// void ReceivePhysicsCollision(FChaosPhysicsCollisionInfo& CollisionInfo);                                                 // [0x148e900] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.OnRep_RepData
	// void OnRep_RepData(FGeometryCollectionRepData& OldData);                                                                 // [0x324da80] Final|Native|Protected|HasOutParms 
	...
	// void NotifyGeometryCollectionPhysicsStateChange__DelegateSignature(class UGeometryCollectionComponent* FracturedComponent); // [0x148e900] MulticastDelegate|Public|Delegate 
	...
	// void NotifyGeometryCollectionPhysicsLoadingStateChange__DelegateSignature(class UGeometryCollectionComponent* FracturedComponent); // [0x148e900] MulticastDelegate|Public|Delegate 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.NetAbandonCluster
	// void NetAbandonCluster(int32_t TransformIndex);                                                                          // [0x324d9f0] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.ApplyPhysicsField
	// void ApplyPhysicsField(bool Enabled, EGeometryCollectionPhysicsTypeEnum Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x324d840] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.ApplyKinematicField
	// void ApplyKinematicField(float Radius, FVector Position);                                                                // [0x324d760] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(16,880) /* FMulticastInlineDelegate */ __um(OnChaosPhysicsCollision);                            // 0x0118   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,881) /* FMulticastInlineDelegate */ __um(OnChaosPhysicsCollision);                            // 0x0100   (0x0010)  
	...
	// void ForceRecreatePhysicsState();                                                                                        // [0x324d9a0] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UGeometryCollectionComponent) == 0x0900); // 2304 bytes (0x000470 - 0x000900)
...
static_assert(offsetof(UGeometryCollectionComponent, ChaosSolverActor) == 0x0478);
static_assert(offsetof(UGeometryCollectionComponent, RestCollection) == 0x0560);
static_assert(offsetof(UGeometryCollectionComponent, InitializationFields) == 0x0568);
static_assert(offsetof(UGeometryCollectionComponent, ObjectType) == 0x0580);
static_assert(offsetof(UGeometryCollectionComponent, DamageThreshold) == 0x0590);
static_assert(offsetof(UGeometryCollectionComponent, ClusterConnectionType) == 0x05A0);
static_assert(offsetof(UGeometryCollectionComponent, PhysicalMaterial) == 0x05B8);
static_assert(offsetof(UGeometryCollectionComponent, InitialVelocityType) == 0x05C0);
static_assert(offsetof(UGeometryCollectionComponent, InitialLinearVelocity) == 0x05C4);
static_assert(offsetof(UGeometryCollectionComponent, InitialAngularVelocity) == 0x05D0);
static_assert(offsetof(UGeometryCollectionComponent, PhysicalMaterialOverride) == 0x05E0);
static_assert(offsetof(UGeometryCollectionComponent, CacheParameters) == 0x05E8);
static_assert(offsetof(UGeometryCollectionComponent, RepData) == 0x06A0);
static_assert(offsetof(UGeometryCollectionComponent, DummyBodySetup) == 0x08D0);
