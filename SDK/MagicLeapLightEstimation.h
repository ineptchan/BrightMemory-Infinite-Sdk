...
public:
	...
	// bool IsTrackerValid();                                                                                                   // [0xf55ff0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.GetColorTemperatureState
	// bool GetColorTemperatureState(FMagicLeapLightEstimationColorTemperatureState& ColorTemperatureState);                    // [0xf55f60] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.GetAmbientGlobalState
	// bool GetAmbientGlobalState(FMagicLeapLightEstimationAmbientGlobalState& GlobalAmbientState);                             // [0xf55eb0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.DestroyTracker
	// void DestroyTracker();                                                                                                   // [0xf55e90] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.CreateTracker
	// bool CreateTracker();                                                                                                    // [0xf55e60] Final|Native|Static|Public|BlueprintCallable 
};
