...
/// Size: 0x04E0 (1248 bytes) (0x0004D8 - 0x0004E0) align 16 MaxSize: 0x04E0
class UControlPointMeshComponent : public UStaticMeshComponent
{ 
public:
	float                                              VirtualTextureMainPassMaxDrawDistance;                      // 0x04D8   (0x0004)  
	unsigned char                                      UnknownData00_7[0x4];                                       // 0x04DC   (0x0004)  MISSED
};
...
public:
	...
	// void SetLandscapeMaterialVectorParameterValue(FName ParameterName, FLinearColor Value);                                  // [0x23487f0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialTextureParameterValue
	// void SetLandscapeMaterialTextureParameterValue(FName ParameterName, class UTexture* Value);                              // [0x2348720] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialScalarParameterValue
	// void SetLandscapeMaterialScalarParameterValue(FName ParameterName, float Value);                                         // [0x2348650] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.LandscapeExportHeightmapToRenderTarget
	// bool LandscapeExportHeightmapToRenderTarget(class UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies); // [0x2348530] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.EditorSetLandscapeMaterial
	// void EditorSetLandscapeMaterial(class UMaterialInterface* NewLandscapeMaterial);                                         // [0x23484a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.EditorApplySpline
	// void EditorApplySpline(class USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32_t NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, class ULandscapeLayerInfoObject* PaintLayer, FName EditLayerName); // [0x2348110] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeUseTessellationComponentScreenSizeFalloff
	// void ChangeUseTessellationComponentScreenSizeFalloff(bool InComponentScreenSizeToUseSubSections);                        // [0x2348080] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeTessellationComponentScreenSizeFalloff
	// void ChangeTessellationComponentScreenSizeFalloff(float InUseTessellationComponentScreenSizeFalloff);                    // [0x2347ff0] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeTessellationComponentScreenSize
	// void ChangeTessellationComponentScreenSize(float InTessellationComponentScreenSize);                                     // [0x2347f60] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeLODDistanceFactor
	// void ChangeLODDistanceFactor(float InLODDistanceFactor);                                                                 // [0x2347ed0] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeComponentScreenSizeToUseSubSections
	// void ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections);                             // [0x2347e40] Native|Public|BlueprintCallable 
};
...
public:
	...
	// void RequestLandscapeUpdate();                                                                                           // [0xb17330] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.Render
	// class UTextureRenderTarget2D* Render(bool InIsHeightmap, class UTextureRenderTarget2D* InCombinedResult, FName& InWeightmapLayerName); // [0x23468d0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.Initialize
	// void Initialize(FTransform& InLandscapeTransform, FIntPoint& InLandscapeSize, FIntPoint& InLandscapeRenderTargetSize);   // [0x2346750] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.GetBlueprintRenderDependencies
	// void GetBlueprintRenderDependencies(TArray<UObject*>& OutStreamableAssets);                                              // [0x148e900] Event|Public|HasOutParms|BlueprintEvent 
};
...
/// Size: 0x0670 (1648 bytes) (0x000448 - 0x000670) align 16 MaxSize: 0x0670
class ULandscapeComponent : public UPrimitiveComponent
{ 
public:
	int32_t                                            SectionBaseX;                                               // 0x0448   (0x0004)  
	int32_t                                            SectionBaseY;                                               // 0x044C   (0x0004)  
	int32_t                                            ComponentSizeQuads;                                         // 0x0450   (0x0004)  
	int32_t                                            SubsectionSizeQuads;                                        // 0x0454   (0x0004)  
	int32_t                                            NumSubsections;                                             // 0x0458   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x045C   (0x0004)  MISSED
	class UMaterialInterface*                          OverrideMaterial;                                           // 0x0460   (0x0008)  
	class UMaterialInterface*                          OverrideHoleMaterial;                                       // 0x0468   (0x0008)  
	TArray<FLandscapeComponentMaterialOverride>        OverrideMaterials;                                          // 0x0470   (0x0010)  
	TArray<class UMaterialInstanceConstant*>           MaterialInstances;                                          // 0x0480   (0x0010)  
	TArray<class UMaterialInstanceDynamic*>            MaterialInstancesDynamic;                                   // 0x0490   (0x0010)  
	TArray<int8_t>                                     LODIndexToMaterialIndex;                                    // 0x04A0   (0x0010)  
	TArray<int8_t>                                     MaterialIndexToDisabledTessellationMaterial;                // 0x04B0   (0x0010)  
	class UTexture2D*                                  XYOffsetmapTexture;                                         // 0x04C0   (0x0008)  
	...
	unsigned char                                      UnknownData02_6[0xC];                                       // 0x04E4   (0x000C)  MISSED
	...
	unsigned char                                      UnknownData03_6[0x4];                                       // 0x05C4   (0x0004)  MISSED
	class UTexture2D*                                  GIBakedBaseColorTexture;                                    // 0x05C8   (0x0008)  
	char                                               MobileBlendableLayerMask;                                   // 0x05D0   (0x0001)  
	unsigned char                                      UnknownData04_6[0x7];                                       // 0x05D1   (0x0007)  MISSED
	...
	unsigned char                                      UnknownData05_7[0x70];                                      // 0x0600   (0x0070)  MISSED


	/// Functions
	// Function /Script/Landscape.LandscapeComponent.GetMaterialInstanceDynamic
	// class UMaterialInstanceDynamic* GetMaterialInstanceDynamic(int32_t InIndex);                                             // [0x2346680] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightByNameAtLocation
	// float EditorGetPaintLayerWeightByNameAtLocation(FVector& InLocation, FName InPaintLayerName);                            // [0x23465a0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightAtLocation
	// float EditorGetPaintLayerWeightAtLocation(FVector& InLocation, class ULandscapeLayerInfoObject* PaintLayer);             // [0x23464c0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x0450 (1104 bytes) (0x000448 - 0x000450) align 16 MaxSize: 0x0450
class ULandscapeGizmoRenderComponent : public UPrimitiveComponent
{ 
public:
	unsigned char                                      UnknownData00_1[0x8];                                       // 0x0448   (0x0008)  MISSED
};
...
/// Size: 0x0530 (1328 bytes) (0x000448 - 0x000530) align 16 MaxSize: 0x0528
class ULandscapeHeightfieldCollisionComponent : public UPrimitiveComponent
{ 
public:
	TArray<class ULandscapeLayerInfoObject*>           ComponentLayerInfos;                                        // 0x0448   (0x0010)  
	int32_t                                            SectionBaseX;                                               // 0x0458   (0x0004)  
	int32_t                                            SectionBaseY;                                               // 0x045C   (0x0004)  
	int32_t                                            CollisionSizeQuads;                                         // 0x0460   (0x0004)  
	float                                              CollisionScale;                                             // 0x0464   (0x0004)  
	int32_t                                            SimpleCollisionSizeQuads;                                   // 0x0468   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x046C   (0x0004)  MISSED
	TArray<char>                                       CollisionQuadFlags;                                         // 0x0470   (0x0010)  
	FGuid                                              HeightfieldGuid;                                            // 0x0480   (0x0010)  
	FBox                                               CachedLocalBox;                                             // 0x0490   (0x001C)  
	TLazyObjectPtr<class ULandscapeComponent*>         RenderComponent;                                            // 0x04AC   (0x001C)  
	unsigned char                                      UnknownData01_6[0x10];                                      // 0x04C8   (0x0010)  MISSED
	TArray<class UPhysicalMaterial*>                   CookedPhysicalMaterials;                                    // 0x04D8   (0x0010)  
	unsigned char                                      UnknownData02_7[0x40];                                      // 0x04E8   (0x0040)  MISSED


	/// Functions
	// Function /Script/Landscape.LandscapeHeightfieldCollisionComponent.GetRenderComponent
	// class ULandscapeComponent* GetRenderComponent();                                                                         // [0x2346720] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x0540 (1344 bytes) (0x000528 - 0x000540) align 16 MaxSize: 0x0540
class ULandscapeMeshCollisionComponent : public ULandscapeHeightfieldCollisionComponent
{ 
public:
	FGuid                                              MeshGuid;                                                   // 0x0528   (0x0010)  
...
/// Size: 0x0500 (1280 bytes) (0x0004D8 - 0x000500) align 16 MaxSize: 0x0500
class ULandscapeMeshProxyComponent : public UStaticMeshComponent
{ 
public:
	FGuid                                              LandscapeGuid;                                              // 0x04D8   (0x0010)  
	TArray<FIntPoint>                                  ProxyComponentBases;                                        // 0x04E8   (0x0010)  
	int8_t                                             ProxyLOD;                                                   // 0x04F8   (0x0001)  
	unsigned char                                      UnknownData00_7[0x7];                                       // 0x04F9   (0x0007)  MISSED
};
...
{ 
public:
	TArray<class ULandscapeSplineControlPoint*>        ControlPoints;                                              // 0x0448   (0x0010)  
	TArray<class ULandscapeSplineSegment*>             Segments;                                                   // 0x0458   (0x0010)  
	TArray<class UMeshComponent*>                      CookedForeignMeshComponents;                                // 0x0468   (0x0010)  
	...
	// TArray<USplineMeshComponent*> GetSplineMeshComponents();                                                                 // [0x234a350] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UControlPointMeshComponent) == 0x04E0); // 1248 bytes (0x0004D8 - 0x0004E0)
...
static_assert(sizeof(ULandscapeComponent) == 0x0670); // 1648 bytes (0x000448 - 0x000670)
...
static_assert(sizeof(ULandscapeGizmoRenderComponent) == 0x0450); // 1104 bytes (0x000448 - 0x000450)
...
static_assert(sizeof(ULandscapeHeightfieldCollisionComponent) == 0x0528); // 1320 bytes (0x000448 - 0x000528)
...
static_assert(sizeof(ULandscapeMeshCollisionComponent) == 0x0540); // 1344 bytes (0x000528 - 0x000540)
static_assert(sizeof(ALandscapeMeshProxyActor) == 0x0228); // 552 bytes (0x000220 - 0x000228)
static_assert(sizeof(ULandscapeMeshProxyComponent) == 0x0500); // 1280 bytes (0x0004D8 - 0x000500)
static_assert(sizeof(ULandscapeSettings) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(sizeof(ULandscapeSplinesComponent) == 0x0480); // 1152 bytes (0x000448 - 0x000480)
...
static_assert(offsetof(ULandscapeComponent, OverrideMaterial) == 0x0460);
static_assert(offsetof(ULandscapeComponent, OverrideHoleMaterial) == 0x0468);
static_assert(offsetof(ULandscapeComponent, OverrideMaterials) == 0x0470);
static_assert(offsetof(ULandscapeComponent, MaterialInstances) == 0x0480);
static_assert(offsetof(ULandscapeComponent, MaterialInstancesDynamic) == 0x0490);
static_assert(offsetof(ULandscapeComponent, LODIndexToMaterialIndex) == 0x04A0);
static_assert(offsetof(ULandscapeComponent, MaterialIndexToDisabledTessellationMaterial) == 0x04B0);
static_assert(offsetof(ULandscapeComponent, XYOffsetmapTexture) == 0x04C0);
...
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, ComponentLayerInfos) == 0x0448);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CollisionQuadFlags) == 0x0470);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, HeightfieldGuid) == 0x0480);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CachedLocalBox) == 0x0490);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, RenderComponent) == 0x04AC);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CookedPhysicalMaterials) == 0x04D8);
...
static_assert(offsetof(ULandscapeMeshCollisionComponent, MeshGuid) == 0x0528);
static_assert(offsetof(ALandscapeMeshProxyActor, LandscapeMeshProxyComponent) == 0x0220);
static_assert(offsetof(ULandscapeMeshProxyComponent, LandscapeGuid) == 0x04D8);
static_assert(offsetof(ULandscapeMeshProxyComponent, ProxyComponentBases) == 0x04E8);
static_assert(offsetof(ULandscapeSplinesComponent, ControlPoints) == 0x0448);
static_assert(offsetof(ULandscapeSplinesComponent, Segments) == 0x0458);
static_assert(offsetof(ULandscapeSplinesComponent, CookedForeignMeshComponents) == 0x0468);
